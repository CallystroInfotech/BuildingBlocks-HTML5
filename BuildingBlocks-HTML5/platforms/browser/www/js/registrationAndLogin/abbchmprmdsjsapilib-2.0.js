var bbreglogin = {
    ...
    chm_saveWalletscore: function (objData) {
        ...
        if((objData.avatarname == "") || (objData.deviceid == "") || (objData.score == "") || (objData.datetime_lastupdated == "")) {
            ...
            if (bbreglogin.erroralerts) {
                console.log("bbreglogin: ERROR: chm_saveWalletscore: values for one or more input parameters are missing.");
            } 
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_saveWalletscore. objData: " + objData.avatarname+", "+objData.deviceid+", "+objData.score+", "+objData.datetime_lastupdated);

        /*
        var query = "INSERT INTO chmwalletscoretbl (avatarname, deviceid, score, datetime_lastupdated) VALUES (?,?,?,?)";
        
        this.bbdbhandler.executeSql(query, [objData.avatarname, objData.deviceid, objData.score, objData.datetime_lastupdated],
            function (rs) {
                if (bbreglogin.debugalerts) {
                    console.log("bbreglogin: resultSet.insertId: " + rs.insertId);
                    console.log("bbreglogin: resultSet.rowsAffected: " + rs.rowsAffected);
                }
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_saveWalletscore: failed" + error.message);
                return false;
            }
        );
        */
        ...
        this.bbdbhandler.sqlBatch([
            ...
            function () {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_saveWalletscore: success");
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_saveWalletscore: failed" + error.message);
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_saveWalletscore");
    },
    ...
    chm_fetchUnsyncedWalletscoreRecords: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchUnsyncedWalletscoreRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                   console.log("bbreglogin: chm_fetchUnsyncedWalletscoreRecords: success. Number of records:"+nrecords);
                
                for (var i = 0; i < nrecords; i++) {
                    arrObjs.push(rs.rows.item(i));
                }
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_fetchUnsyncedWalletscoreRecords: arrObjs: " + JSON.stringify(arrObjs));

                callbackfn(arrObjs); // Invoke the callback function to send the array of Objects with the fetched records
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_fetchUnsyncedWalletscoreRecords: failed" + error.message);
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_fetchUnsyncedWalletscoreRecords");
    ...
    chm_fetchUnsyncedWalletscoreRecords_cbf: function (arrRecords) {
        ...
        if(bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchUnsyncedWalletscoreRecords_cbf");
    ...
    chm_markSyncedWalletscoreRecords: function (ids) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_markSyncedWalletscoreRecords. ids:" + ids + "  query: "+query);

        if ((ids.length == 0) || (ids == '')) {
            if (bbreglogin.debugalerts)
                console.log("bbreglogin: Empty list of 'id's. No action performed.");
            return true;
        }
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: chm_markSyncedWalletscoreRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts) 
                    console.log("bbreglogin: chm_markSyncedWalletscoreRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Exit chm_markSyncedWalletscoreRecords");
    },
    ...
    chm_deleteSyncedWalletscoreRecords: function () {
        ...
        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Enter chm_deleteSyncedWalletscoreRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: chm_deleteSyncedWalletscoreRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_deleteSyncedWalletscoreRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Exit chm_deleteSyncedWalletscoreRecords");
    },
    ...
    chm_saveGameplay: function (objData) {
        ...
        if((objData.id_game == "") || (objData.avatarname == "") || (objData.deviceid == "") || (objData.start_time == "") || (objData.hints == "")) {
            ...
            if (bbreglogin.erroralerts) {
                console.log("bbreglogin: ERROR: prm_saveGameplay: values for one or more input parameters are missing.");
            } 
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_saveGameplay. objData: " + objData.id_game+", "+objData.avatarname+", "+objData.deviceid+", "+objData.start_time+", "+objData.hints);
        ...
        this.bbdbhandler.executeSql(query, [gameplayid, objData.id_game, objData.avatarname, objData.deviceid, objData.start_time, objData.hints],
            function (rs) {
                if (bbreglogin.debugalerts) {
                    console.log("bbreglogin: chm_saveGameplay: success. id_game_play: " + gameplayid);
                    console.log("bbreglogin: resultSet.insertId: " + rs.insertId);
                    console.log("bbreglogin: resultSet.rowsAffected: " + rs.rowsAffected);
                }
            ...
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_saveGameplay: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_saveGameplay");
    ...
    chm_fetchUnsyncedGameplayRecords: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchUnsyncedGameplayRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                   console.log("bbreglogin: chm_fetchUnsyncedGameplayRecords: success. Number of records:"+nrecords);
                
                for (var i = 0; i < nrecords; i++) {
                    arrObjs.push(rs.rows.item(i));
                }
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_fetchUnsyncedGameplayRecords: arrObjs: " + JSON.stringify(arrObjs));

                callbackfn(arrObjs); // Invoke the callback function to send the array of Objects with the fetched records
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_fetchUnsyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_fetchUnsyncedGameplayRecords");
    ...
    chm_fetchUnsyncedGameplayRecords_cbf: function (arrRecords) {
        ...
        if(bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchUnsyncedGameplayRecords_cbf");
    ...
    chm_markSyncedGameplayRecords: function (ids) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_markSyncedGameplayRecords. ids:" + ids + "  query: "+query);
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: chm_markSyncedGameplayRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts) 
                    console.log("bbreglogin: chm_markSyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Exit chm_markSyncedGameplayRecords");
    },
    ...
    chm_deleteSyncedGameplayRecords: function () {
        ...
        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Enter chm_deleteSyncedGameplayRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: chm_deleteSyncedGameplayRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_deleteSyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Exit chm_deleteSyncedGameplayRecords");
    },
    ...
    chm_saveAssessment: function (objData) {
        ...
        if((objData.id_game_play == "") || (objData.id_question == "") || (objData.pass == "") || (objData.time2answer == "") || (objData.date_time_submission == "") || (objData.avatarname == "") || (objData.deviceid == "")) {
            ...
            if (bbreglogin.erroralerts) {
                console.log("bbreglogin: ERROR: chm_saveAssessment: values for one or more input parameters are missing.");
            } 
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_saveAssessment. objData: " + objData.id_game_play + ", " + objData.id_question + ", " + objData.pass + ", " + objData.time2answer + ", " + objData.date_time_submission + ", " + objData.avatarname + ", " + objData.deviceid);
        ...
        this.bbdbhandler.executeSql(query, [objData.id_game_play, objData.id_question, objData.pass, objData.time2answer, objData.date_time_submission, objData.avatarname, objData.deviceid],
            function (rs) {
                if (bbreglogin.debugalerts) {
                    console.log("bbreglogin: chm_saveAssessment: success");
                    console.log("bbreglogin: resultSet.insertId: " + rs.insertId);
                    console.log("bbreglogin: resultSet.rowsAffected: " + rs.rowsAffected);
                }
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_saveAssessment: failed" + error.message);
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_saveAssessment");
    },
    ...
    chm_fetchUnsyncedAssessmentRecords: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchUnsyncedAssessmentRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_fetchUnsyncedAssessmentRecords: success. Number of records:" + nrecords);

                for (var i = 0; i < nrecords; i++) {
                    arrObjs.push(rs.rows.item(i));
                }
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: arrObjs: " + JSON.stringify(arrObjs));

                callbackfn(arrObjs); // Invoke the callback function to send the array of Objects with the fetched records
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_fetchUnsyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_fetchUnsyncedAssessmentRecords");
    ...
    chm_fetchUnsyncedAssessmentRecords_cbf: function (arrRecords) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchUnsyncedAssessmentRecords_cbf");
    ...
    chm_markSyncedAssessmentRecords: function (ids) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_markSyncedAssessmentRecords. ids:" + ids + "  query: " + query);
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_markSyncedAssessmentRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_markSyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_markSyncedAssessmentRecords");
    },
    ...
    chm_deleteSyncedAssessmentRecords: function () {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_deleteSyncedAssessmentRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_deleteSyncedAssessmentRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_deleteSyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_deleteSyncedAssessmentRecords");
    },
    ...
    chm_saveGameMasterData: function (objData) {
        ...
        if((objData.id == "") || (objData.id_game == "") || (objData.id_grade == "")) {
            ...
            if (bbreglogin.erroralerts) {
                console.log("bbreglogin: ERROR: chm_saveGameMasterData: values for one or more input parameters are missing.");
            } 
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_saveGameMasterData. objData: " + objData.id + ", "+ objData.id_game + ", " + objData.game_description + ", " + objData.id_grade + ", " + objData.gametoopen + ", " + objData.prerequisitegame);


        var query = "INSERT INTO chmgamemastertbl (id, id_game, game_description, id_grade, gametoopen, prerequisitegame) VALUES (?,?,?,?,?,?)";

        this.bbdbhandler.executeSql(query, [objData.id, objData.id_game, objData.game_description, objData.id_grade, objData.gametoopen, objData.prerequisitegame],
            function (rs) {
                if (bbreglogin.debugalerts) {
                    console.log("bbreglogin: chm_saveGameMasterData: success");
                    console.log("bbreglogin: resultSet.insertId: " + rs.insertId);
                    console.log("bbreglogin: resultSet.rowsAffected: " + rs.rowsAffected);
                }
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_saveGameMasterData: failed" + error.message);
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_saveGameMasterData");
    },
    ...
    chm_fetchGameMasterData: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter chm_fetchGameMasterData");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: chm_fetchGameMasterData: success. Number of records:" + nrecords);
            ...
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: chm_fetchGameMasterData: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit chm_fetchGameMasterData");
    ...
    chm_fetchGameMasterData_cbf: function (arrRecords) {
        ...
        if (bbreglogin.debugalerts) {
            console.log("bbreglogin: Enter chm_fetchGameMasterData_cbf");
        }
    ...
    prm_saveGameplay: function (objData) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_saveGameplay. objData: " + objData.id_game+", "+objData.avatarname+", "+objData.deviceid+", "+objData.start_time);
        ...
        this.bbdbhandler.executeSql(query, [gameplayid, objData.id_game, objData.avatarname, objData.deviceid, objData.start_time],
            function (rs) {
                if (bbreglogin.debugalerts) {
                    console.log("bbreglogin: prm_saveGameplay: success. id_game_play: " + gameplayid);
                    console.log("bbreglogin: resultSet.insertId: " + rs.insertId);
                    console.log("bbreglogin: resultSet.rowsAffected: " + rs.rowsAffected);
                }
                // return gameplayid; // IMPORTANT NOTE: This 'return' statement here WILL NOT WORK. SQLlite functions are executed asynchronously. 
            ...
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_saveGameplay: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_saveGameplay");
    ...
    prm_fetchUnsyncedGameplayRecords: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_fetchUnsyncedGameplayRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                   console.log("bbreglogin: prm_fetchUnsyncedGameplayRecords: success. Number of records:"+nrecords);
                
                for (var i = 0; i < nrecords; i++) {
                    arrObjs.push(rs.rows.item(i));
                }
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_fetchUnsyncedGameplayRecords: arrObjs: " + JSON.stringify(arrObjs));

                callbackfn(arrObjs); // Invoke the callback function to send the array of Objects with the fetched records
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_fetchUnsyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_fetchUnsyncedGameplayRecords");
    ...
    prm_fetchUnsyncedGameplayRecords_cbf: function (arrRecords) {
        ...
        if(bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_fetchUnsyncedGameplayRecords_cbf");
    ...
    prm_markSyncedGameplayRecords: function (ids) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_markSyncedGameplayRecords. ids:" + ids + "  query: "+query);
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: prm_markSyncedGameplayRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts) 
                    console.log("bbreglogin: prm_markSyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Exit prm_markSyncedGameplayRecords");
    },
    ...
    prm_deleteSyncedGameplayRecords: function () {
        ...
        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Enter prm_deleteSyncedGameplayRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: prm_deleteSyncedGameplayRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_deleteSyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts) 
            console.log("bbreglogin: Exit prm_deleteSyncedGameplayRecords");
    },
    ...
    prm_saveAssessment: function (objData) {
        ...
        if((objData.id_game_play == "") || (objData.id_question == "") || (objData.pass == "") || (objData.time2answer == "") || (objData.attempts == "") || (objData.date_time_submission == "") || (objData.avatarname == "") || (objData.deviceid == "")) {
        	...
        	if (bbreglogin.erroralerts) {
                console.log("bbreglogin: ERROR: prm_saveAssessment: values for one or more input parameters are missing.");
            } 
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_saveAssessment. objData: " + objData.id_game_play + ", " + objData.id_question + ", " + objData.pass + ", " + objData.time2answer + ", " + objData.attempts + ", " + objData.date_time_submission + ", " + objData.avatarname);
        ...
        this.bbdbhandler.executeSql(query, [objData.id_game_play, objData.id_question, objData.pass, objData.time2answer, objData.attempts, objData.date_time_submission, objData.avatarname, objData.deviceid],
            function (rs) {
                if (bbreglogin.debugalerts) {
                    console.log("bbreglogin: prm_saveAssessment: success");
                    console.log("bbreglogin: resultSet.insertId: " + rs.insertId);
                    console.log("bbreglogin: resultSet.rowsAffected: " + rs.rowsAffected);
                }
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_saveAssessment: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_saveAssessment");
    },
    ...
    prm_fetchUnsyncedAssessmentRecords: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_fetchUnsyncedAssessmentRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_fetchUnsyncedAssessmentRecords: success. Number of records:" + nrecords);
            ...
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_fetchUnsyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_fetchUnsyncedAssessmentRecords");
    ...
    prm_fetchUnsyncedAssessmentRecords_cbf: function (arrRecords) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_fetchUnsyncedAssessmentRecords_cbf");
    ...
    prm_markSyncedAssessmentRecords: function (ids) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_markSyncedAssessmentRecords. ids:" + ids + "  query: " + query);
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_markSyncedAssessmentRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_markSyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_markSyncedAssessmentRecords");
    },
    ...
    prm_deleteSyncedAssessmentRecords: function () {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_deleteSyncedAssessmentRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_deleteSyncedAssessmentRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_deleteSyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_deleteSyncedAssessmentRecords");
    },
    ...
    prm_saveInteractEvent: function (objData) {
        ...
        if((objData.id_game_play == "") || (objData.id_question == "") || (objData.date_time_event == "") || (objData.event_type == "") || (objData.res_id == "") || (objData.avatarname == "") || (objData.deviceid == "")) {
        	if (bbreglogin.erroralerts) {
                console.log("bbreglogin: ERROR: prm_saveInteractEvent: values for one or more input parameters are missing.");
            } 
            return false;
        }

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_saveInteractEvent. objData: " + objData.id_game_play + ", " + objData.id_question + ", " + objData.date_time_event + ", " + objData.event_type + ", " + objData.res_id + ", "+ objData.avatarname + ", " + objData.deviceid);
        ...
        this.bbdbhandler.executeSql(query, [objData.id_game_play, objData.id_question, objData.date_time_event, objData.event_type, objData.res_id, objData.avatarname, objData.deviceid],
            function (rs) {
                if (bbreglogin.debugalerts) 
                    console.log("bbreglogin: prm_saveInteractEvent: success");
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_saveInteractEvent: failed" + error.message);
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_saveInteractEvent");
    },
    ...
    prm_fetchUnsyncedInteractEventRecords: function (callbackfn) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_fetchUnsyncedInteractEventRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_fetchUnsyncedInteractEventRecords: success. Number of records:" + nrecords);
            ...
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_fetchUnsyncedInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_fetchUnsyncedInteractEventRecords");
    ...
    prm_fetchUnsyncedInteractEventRecords_cbf: function (arrRecords) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_fetchUnsyncedInteractEventRecords_cbf");
    ...
    prm_markSyncedInteractEventRecords: function (ids) {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_markSyncedInteractEventRecords. ids:" + ids + "  query: " + query);
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_markSyncedInteractEventRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_markSyncedInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_markSyncedInteractEventRecords");
    },
    ...
    prm_deleteSyncedInteractEventRecords: function () {
        ...
        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Enter prm_deleteSyncedInteractEventRecords");
        ...
        this.bbdbhandler.executeSql(query, [],
            function (rs) {
                if (bbreglogin.debugalerts)
                    console.log("bbreglogin: prm_deleteSyncedInteractEventRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (bbreglogin.erroralerts)
                    console.log("bbreglogin: prm_deleteSyncedInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (bbreglogin.debugalerts)
            console.log("bbreglogin: Exit prm_deleteSyncedInteractEventRecords");
    },
    ...
    reload: function () {
        ...
        console.log("bbreglogin: in reload");
        location.reload(); // to be used when transitioning the page
    },

    echoTest: function () {
        window.sqlitePlugin.echoTest(function () {
            console.log('bbreglogin: ECHO Test OK');
    ...
    selfTest: function () {
        window.sqlitePlugin.selfTest(function () {
            console.log('bbreglogin: SELF Test OK');
    ...
    invokeRESTAPI: function (apiname, jsondata) {
        ...
        $.ajax({
            ...
            error: function (error) {
                rtn = false;
                console.log("bbreglogin: invokeRESTAPI failed: api: "+apiurl+" error: "+error.toString());
            }
        });
    ...
    deleteSyncedRecords: function (apiname, jsonresp) {
        ...
        switch (apiname) {
            ...
            case 'txabbchmwalletscore':
                ...
                bbreglogin.chm_deleteWalletscoreRecordsByIds(arrIds1.toString());
            ...
            case 'txabbchmgameplay':
                ...
                // bbreglogin.chm_markSyncedGameplayRecords(arrIds1.toString());
                // Delete 'Synced' records
                // bbreglogin.chm_deleteSyncedGameplayRecords();
                bbreglogin.chm_deleteGameplayRecordsByIds(arrIds1.toString());
            ...
            case 'txabbchmgameplaydetail':
                ...
                // Mark fetched records as 'Synced'
                // bbreglogin.prm_markSyncedAssessmentRecords(arrIds2.toString());
                // Delete 'Synced' records
                // bbreglogin.prm_deleteSyncedAssessmentRecords();
                bbreglogin.chm_deleteAssessmentRecordsByIds(arrIds2.toString());
            ...
            case 'txabbprmgameplay':
                ...
                // Mark fetched records as 'Synced'
                // bbreglogin.prm_markSyncedGameplayRecords(arrIds1.toString());
                // Delete 'Synced' records
                // bbreglogin.prm_deleteSyncedGameplayRecords();
                bbreglogin.prm_deleteGameplayRecordsByIds(arrIds1.toString());
            ...
            case 'txabbprmgameplaydetail':
                ...
                // Delete 'Synced' records
                // bbreglogin.prm_deleteSyncedAssessmentRecords();
                bbreglogin.prm_deleteAssessmentRecordsByIds(arrIds2.toString());
            ...
            case 'txabbprmekstepevents':
                ...
                // Mark fetched records as 'Synced'
                // bbreglogin.prm_markSyncedInteractEventRecords(arrIds3.toString());
                // Delete 'Synced' records
                // bbreglogin.prm_deleteSyncedInteractEventRecords();
                bbreglogin.prm_deleteInteractEventRecordsByIds(arrIds3.toString());
                break;
        }
    }
};
